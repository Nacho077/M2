...
// Tu codigo acá:
let toDoItems = [new ToDo("hacer la homework"), new ToDo("Asistir al CR")];
...
var span = document.querySelector("#createdBy") //.test
// var span2 = document.getElementById("createdBy")
...
function buildToDo(todo, index) {
  ...
  // toDoShell.listClass.push("toDoShell")
...
function buildToDos(listaTareas) {
  // Tu código acá: buildToDo(listaTareas[i], i)
  return listaTareas.map((tarea, index) => buildToDo(tarea, index))
  // let arr = toDos.map((t, i) => buildToDo(t, i)) 
  // return arr; 
}

// [{descripcion: "Hacer homework"}, {descripcion: "Repasar css"}] => [
//   <div class='toDoShell'>
//       <span id=0> 
//           Hacer homework 
//       </span>
