...
// Tu codigo acá:
const toDoItems = [new ToDo('Hacer la homework')]
...
span.innerHTML = span.innerHTML + ' Nacho'
...
function buildToDo(todo, index) {
  ...
  toDoShell.className = 'toDoShell' // clase1 clase2 => toDoSHel
  // toDoShell.classList.add('toDoShell') // clase1 clase2 => clase1 clase2 toDoShell
  // toDoShell.setAttribute('class', 'toDoShell') // clase1 clase2 => toDoShell
...
// [{description: 'description1', complete: false}, {description: 'description12', complete: false}] => 
// [<div><span id=0>description1</span></div>, <div><span id=1>description2</span></div>]
function buildToDos(toDos) {
  // Tu código acá:
  var result = toDos.map((tarea, index) => buildToDo(tarea, index))
  return result
}
